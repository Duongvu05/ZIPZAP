...
parser.add_argument("--input_dir", type=str, default="/home/phinn/BERT4ETH/BERT4ETH_PyTorch-1/pretrain/outputs/zipzap_exp_epoch_5", help="the input directory of address and embedding list")
...
def main():
    ...
    with open("/home/phinn/BERT4ETH/ZIPZAP/data/phisher_account.txt", "r") as f:
        for line in f.readlines():
            phisher_account_set.add(line[:-1])

    address_list = np.load("/home/phinn/BERT4ETH/ZIPZAP/outputs/zipzap_exp_epoch_270/address.npy")
    embedding_list = np.load("/home/phinn/BERT4ETH/ZIPZAP/outputs/zipzap_exp_epoch_270/embedding.npy")
